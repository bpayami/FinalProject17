"""
REFERENCE NOTES:
G o a l : create a working function that works seamlessly with all do_'s

Still not working with the wings.  I am going to attempt to consolidate both the separate wings and general rooms into one function in file 2.0
"""
...
worldRooms = {
    ...
    'Locked Room': {
        ...
        'FORWARD': '',
        'BACK': ''},
    'Wing A': {'DESC': 'placeholder'}, 'Wing B': {'DESC': 'placeholder'}, 'Wing C': {'DESC': 'placeholder'}, 'Wing D': {'DESC': 'placeholder'},
    }
...
#THIS WAS THE BEFORE WORKING ONE
while True:
    if location != 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        location = location
        parameters = {
...
#write out class Room instructions for each room
#create a continuous for loop
#account for Hallway junction things
#account for if command isn't recognized
#change you see doors
#add objects
#make object dictionary
#make object class
#add objects to while loop
#add command options