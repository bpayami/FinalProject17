#LOOP IS WORKING WITH THE MAIN HALL FROM WING _ BUT IT STILL PRINTS THE ROOM TITLE AS MAIN HALL FROM WING _
#EITHER BRING BACK THE HALL CLASS
#OR PUT IT IN AN IF STATEMENT TO ALTER NAME BACK TO JUST MAIN HALL
