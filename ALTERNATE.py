...
while True:
    if location != 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        ...
        self.nextTurn()
        user_input = str(input('\n> ')).upper()  #HOLD UPPPPPPP! MAYBE I CAN GET THIS TO LEAD INTO THE CMD LOOP THEN BACK INTO THIS WHILE STATEMENT!!!!!
        ...
        if user_input == 'LOOK': #(f'LOOK' + worldRooms[location]['GROUND'])
