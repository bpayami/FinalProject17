...
def moveDirection(direction):
    ...
    if prevlocation != 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        #all input converting needs to go here... as in remove space and .upper
        #perhaps make a input conversion function?????
        newlocation = worldRooms[prevlocation]['DOORS'][direction.upper()]
        #then call class with description

    elif prevlocation == 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        newlocation == worldWings[prevlocation][direction.upper()]

    if newlocation != 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        parameters = {
        ...
        location_modified = newlocation.lower()
    ...
    elif newlocation == 'Wing A' or 'Wing B' or 'Wing C' or 'Wing D':
        parameters = {
        ...
        newlocation = worldRooms[name_3]['DOORS'][direction]
        prevlocation = location
        location = newlocation
...
class TextAdventureCmd(cmd.Cmd):
    ...
    #"""default function is called when user input is not a recognized command"""
    def default(self, arg):
        print('I do not understand that command. Type "help" for a list of commands.')

    #command will end the program
...
def moveDirection(direction):
    ...
    if direction in worldRooms[location]['DOORS']:
        print('it works')
        print('You move to the %s.' % direction)
        location = worldRooms[location]['DOORS'][direction]
...
#Prints the description of the first room start
start = Room(location, worldRooms[location]['DESC'], back=False, left=False, right=False)
start.nextTurn()
print(' ')

print(moveDirection('forward'))
